...
function registerCollections(eleventyConfig) {
  eleventyConfig.addCollection("blogposts", collectionApi => collectionApi.getFilteredByGlob("src/blog/*.md"));
  eleventyConfig.addCollection("sins", collectionApi => collectionApi.getFilteredByGlob("src/webdev-sins/*.md"));
  eleventyConfig.addCollection("posts", collectionApi => collectionApi.getFilteredByGlob(["src/blog/*.md", "src/webdev-sins/*.md"]));
}
